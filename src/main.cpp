...
/*
const char* ssid     = "FIF_Innovacion"; // Cambiar si estás en otra red.
const char* password = "F1f@1Nn0v@"; // Cambiar si estás en otra red.
*/

// Access Point Wi-Fi
const char* AP_SSID = "hotsopt_2";
const char* AP_PASS = "cantuuuuu";
